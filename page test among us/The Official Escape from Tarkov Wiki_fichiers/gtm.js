...
"resource": {
  ...
  "tags":[{
      ...
      "consent":["list"],
      "once_per_load":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003E(function(){function c(a){for(var d=window.dataLayer,b=0;b\u003Cd.length;b++){var e=d[b].fandom;e\u0026\u0026(d[b]={fandom:Object.assign(e,a)})}}window.dataLayer=window.dataLayer||[];window.dataLayer.push({fandom:{app:\"ucp\",\"country-code\":\"",["escape",["macro",8],7],"\",mwCanonicalNamespace:window.wgCanonicalNamespace,isMainNamespace:\"",["escape",["macro",9],7],"\",userId:",["escape",["macro",10],8,16],",trackingQueueConsent:!1,wgCityId:window.wgCityId,lightDark:\"\",infobox:\"\",table:\"\",navbox:\"\",uniquePageviewID:\"\",hasFeaturedVideo:\"\",pageType:\"\",\nskin:mw.config.get(\"skin\")}});window.ads\u0026\u0026window.ads.pushToConsentQueue\u0026\u0026window.ads.pushToConsentQueue(function(a){a\u0026\u0026(a.geoRequiresConsent\u0026\u0026a.gdprConsent?c({trackingQueueConsent:!0}):a.geoRequiresConsent||c({trackingQueueConsent:!0}))});c({fullVerticalName:mw.config.get(\"fullVerticalName\")})})();\u003C\/script\u003E"],
      ...
      "vtp_boundaries":["list",["zb","_eq",["macro",5],"paused",false,false]],
      "vtp_enableTypeRestrictions":false,
      "tag_id":294
    },{
      "function":"__html",
      ...
      "consent":["list"],
      "once_per_event":true,
      "vtp_html":["template","\n\u003Cscript type=\"text\/gtmscript\"\u003E(function(){var a=document.createElement(\"script\");a.src=\"https:\/\/ak.sail-horizon.com\/spm\/spm.v1.min.js\";a.onload=function(){console.log(\"\\n\\n\\n\\n\\n\\n\\nheeeeeerererererer\");var b=\"dev-\"+Math.floor(5*Math.random())+\"-random-tag\",c=\"",["escape",["macro",16],7],"\",d=\"c9322e218da57e71a4965ae18fecbefa\";Sailthru.init({customerId:d,autoTrackPageview:!1,useStoredTags:!1});Sailthru.track(\"pageview\",{url:window.location.href,tags:[b,c,\"dev-constant-tag\"],onSuccess:function(){console.log(\"trackPageView success note\")},\nonError:function(){console.log(\"trackPageView failure note\")}})};document.head.append(a)})();\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":39
  ...
  "predicates":[{
      ...
      "function":"_cn",
      "arg0":["macro",5],
      "arg1":"sailthruenabled"
    }],
  "rules":[
    [["if",0],["add",1,2,4,6,7,8,9,0]],
    [["if",1],["add",3]],
    [["if",2],["add",5]],
    [["if",3,4,5],["add",10]],
    [["if",5,6],["add",10]],
